...
<title>STOREID FOR DELETE</title>
<sx:head />
<script>
...
<s:if
	...
	<s:form id="form1">
		<sx:autocompleter name="storebean.storeID" list="storeidList"
			label="Select StoreID     " valueNotifyTopics="/value" />
		<s:hidden name="action" value="viewByStoreId"></s:hidden>
		<%-- <s:submit name="submit"></s:submit> --%>
	</s:form>
	<s:url value="viewByStoreId1.action" id="url" />
