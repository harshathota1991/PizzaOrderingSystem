...
<s:if
	...
	<s:form id="form1">
		<sx:autocompleter name="foodBean.foodID" list="foodidList"
			label="Select FoodID     " valueNotifyTopics="/value" />
		<s:hidden name="action" value="viewByFoodId1"></s:hidden>
		<%-- <s:submit name="submit"></s:submit> --%>
	</s:form>
	<s:url value="viewByFoodId1.action" id="url" />
